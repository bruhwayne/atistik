            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField('Baba Adı (İsteğe Bağlı)', 'Baba Adı Giriniz', _fatherNameController),
                  const SizedBox(height: 16),
                  _buildTextField('Anne Adı (İsteğe Bağlı)', 'Anne Adı Giriniz', _motherNameController),
                  const SizedBox(height: 16),
                  _buildTextField('Sahip Adı (İsteğe Bağlı)', 'Sahip Adı Giriniz', _ownerNameController),
                  const SizedBox(height: 16),
                  _buildTextField('Antrenör Adı (İsteğe Bağlı)', 'Antrenör Adı Giriniz', _trainerNameController),
                  const SizedBox(height: 16),
